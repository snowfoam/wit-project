module.exports = {
  db: 'mongodb://127.0.0.1:27017/qq3',
  smtp:{
    get host(){
      return 'smtp.qq.com'
    },
    ...
    <div style="margin:40px auto;width:90%">
      <div
        ...
        <p> Please protect your verification code properly: <strong> ${code} </strong> ，And fill in in one minute. </p>
        <p style="text-align: right"> Sincerely thank you for your registration</p>
       </div>
      <style type="text/css">
        a:link {
